...
# 기존 훈련 스크립트(gemini.py)와 템플릿에서 환경 및 설정 구조 임포트
# 파일 이름이 다를 경우 'gemini' 부분을 실제 훈련 파일 이름으로 변경하세요.
from pendulum_balance import NewtonPendulumCfg, NewtonPendulumBackend
